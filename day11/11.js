...
function createSeatDataStructs2(seatRows) {
    const flatList = [];
    const rowLength = seatRows[0].length;
    for (let i = 0; i < seatRows.length; i++) {
        const row = seatRows[i];
            ...
            if (row[j] === "L") {
                ...
                if (j !== 0) {
                    ...
                    do {
                        currentRowIndex--;
                        currentRow++;
                    } while (currentRow < seatRows.length &&
                        currentRowIndex >= 0 &&
                        seatRows[currentRow][currentRowIndex] === ".");
                    if (currentRow < seatRows.length &&
                        currentRowIndex >= 0 &&
                        seatRows[currentRow][currentRowIndex] !== ".") {
                        adjacentSeatLocations.push(currentRow * rowLength + currentRowIndex);
                    }
